...
ggsave("./img/emu/vowels-z-bark.png", width = 7, height = 5)
```
...
ggsave("./img/emu/vot-jitter.png", width = 7, height = 4)
```
...
ggsave("./img/emu/intonation.png", width = 7, height = 7)
```
...
ggsave("./img/emu/intonation-all.png", width = 14, height = 10)
```
...
ggsave("./img/emu/cog.png", width = 7, height = 5)
```
...
ggsave("./img/emu/uti-laterals.png", width = 7, height = 5)
```
...
ggsave("./img/emu/uti-vowels-all.png", width = 7, height = 5)
```
