...
library(tidyverse)
theme_set(theme_light(base_family = "DejaVu Sans", base_size = 14))
library(tikzDevice)
library(zoo)
library(scales)
library(rticulate)
...
ggsave("./img/emu/vowels-z.svg", width = 7, height = 5)
```
...
ggsave("./img/emu/vowels-z-hz.svg", width = 7, height = 5)
```
...
ggsave("./img/emu/vowels-z-hz-ipa.svg", width = 7, height = 5)
```
...
ggsave("./img/emu/vowels-z-bark.svg", width = 7, height = 5)
```
...
ggsave("./img/emu/vowels-z-hz-log.svg", width = 7, height = 5)
```
...
ggsave("./img/emu/vot-jitter.svg", width = 7, height = 4)
```
...
ggsave("./img/emu/intonation.svg", width = 7, height = 7)
```
...
ggsave("./img/emu/intonation-all.svg", width = 14, height = 10)
```
...
ggsave("./img/emu/cog.svg", width = 7, height = 5)
```
...
ggsave("./img/emu/uti-laterals.svg", width = 7, height = 5)
```
...
ggsave("./img/emu/uti-laterals-all.svg", width = 7, height = 5)
```
...
ggsave("./img/emu/uti-vowels-all.svg", width = 7, height = 5)
```
...
ggsave("./img/emu/uti-vowels-gam.svg", width = 7, height = 5)
```
